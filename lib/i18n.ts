...
const i18n = new I18n({
  ...
  'pt-BR': {
    ...
    friendlist_onboarding_long_press: "Mantenha pressionado para escolher o som que será enviado ao deslizar",
  ...
  'de': {
    ...
    empty_friendlist_search_pseudo: "Suche Freunde mit ihrem Benutzernamen.",
    empty_friendlist_invite_friends: "Lade Freunde ein, dir beizutreten.",
    no_friends_phone_hint: "Trag deine Nummer ein, um mit deinen Kontakten gematcht zu werden.",
    friendlist_loading_too_long: "Das Laden deiner Freunde dauert zu lange. Bitte versuche es erneut.",
    ...
    blocked_friends_unblock_error: "Dieser Benutzer konnte nicht entsperrt werden.",
    report_message_title: "Diese Nachricht melden",
    report_message_reason_prompt: "Wähle den Grund der Meldung",
    report_conversation_title: "Diese Unterhaltung melden",
    report_conversation_reason_prompt: "Wähle den Grund für die Meldung dieser Unterhaltung",
    report_reason_spam: "Spam",
    ...
    // Search
    search_title: "Einen Freund finden",
    ...
    soundcheck_subtitle_toot_android: "Pups auf französische Art",
    ...
    review_app_functions: "Tutorial erneut ansehen",
