...
const i18n = new I18n({
  fr: {
    ...
    onboarding_notifications_desc: "Tout l'intérêt de communiquer avec vos amis sur Proot ! est les notifications. Acceptez-les pour jouer le jeu !",
  ...
  'pt-BR': {
    ...
    onboarding_notifications_desc: "O lance de falar com os amigos no Proot ! são as notificações. Aceita aí pra brincar!",
  ...
  de: {
    ...
    onboarding_notifications_desc: "Ohne Benachrichtigungen macht es keinen Spaß. Bitte zulassen!",
