...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // 1 heure : les données sont considérées comme fraîches plus longtemps
      // ce qui évite les Spinners au retour sur une page.
      staleTime: 1000 * 60 * 60,
      // 7 jours : garde les données en cache mémoire (ou disque si persisté)
